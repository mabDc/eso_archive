...
@Entity(nameInDb:'rule',propertyList:[
  Property(name:'id',type:PropertyType.INT,isPrimary:true),
  Property(name:'name',type:PropertyType.STRING),
  Property(name:'host',type:PropertyType.STRING),
  Property(name:'contentType',type:PropertyType.STRING),
  Property(name:'discoverUrl',type:PropertyType.STRING),
  Property(name:'discoverItems',type:PropertyType.STRING),
  Property(name:'searchUrl',type:PropertyType.STRING),
  Property(name:'searchItems',type:PropertyType.STRING),
  Property(name:'detailUrl',type:PropertyType.STRING),
  Property(name:'detailItems',type:PropertyType.STRING),
  Property(name:'chapterUrl',type:PropertyType.STRING),
  Property(name:'chapterItems',type:PropertyType.STRING),
  Property(name:'contentUrl',type:PropertyType.STRING),
  Property(name:'contentItems',type:PropertyType.STRING),
  Property(name:'enCheerio',type:PropertyType.INT),
  Property(name:'enMultiRoads',type:PropertyType.INT),
  Property(name:'enable',type:PropertyType.INT),
  ])
class Rule {
  Rule();
